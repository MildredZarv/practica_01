...
//        CollegeEmployee[] pers=new CollegeEmployee[3];
//        for (int i = 0; i < 3; i++) {
//            pers[i]=new CollegeEmployee();
//        }
//        
//        for (int i = 0; i < 3; i++) {
...
//            pers[i].setnombre(nombre);
//            pers[i].setpaterno(apellido);
//            pers[i].setmaterno(materno);
//            
...
//                String dep=in.next();
//                pers[i].setSalario(salario);
//                pers[i].setnumeroSeguro(nuseguro);
//                pers[i].setdepartamento(dep);
//            
//        }
